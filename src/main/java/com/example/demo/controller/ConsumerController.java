...
import com.example.demo.common.FatalMessage;
import com.example.demo.common.SuccessMessage;
import com.example.demo.common.WarningMessage;
...
public class ConsumerController {
    ...
    public Object loginStatus(HttpServletRequest req, HttpSession session){
        ...
        if(res){
            ...
            return new SuccessMessage<List<Consumer>>("登陆成功",consumerService.loginStatus(username)).getMessage();
        }else{
