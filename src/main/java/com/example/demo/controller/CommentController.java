...
import com.example.demo.service.impl.CommentServicelmpl;
...
public class CommentController {
    ...
    public Object addComment(HttpServletRequest req){
        ...
        if(res){
            return new SuccessMessage<Null>("评论成功");
        }else{
    ...
    public Object deleteComment(HttpServletRequest req){
        ...
        if(res){
            return new SuccessMessage<Null>("删除成功");
        }else{
            return new ErrorMessage("删除失败");
        }
    }
    ...
    public Object commentOfSongListId(HttpServletRequest req){
        ...
        return new SuccessMessage<List<Comment>>(null,commentService.commentOfSongListId(Integer.parseInt(songListId))).getMessage();
    }
