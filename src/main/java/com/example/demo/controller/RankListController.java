...
import com.example.demo.service.impl.RankListServiceImpl;
...
public class RankListController {
    ...
    public Object getUserRank(HttpServletRequest req){
        ...
        return new SuccessMessage<Number>(null,rankListService.getUserRank(Long.parseLong(consumerId),Long.parseLong(songListId)))
                .getMessage();
    }
}
